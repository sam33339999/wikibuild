...
func TestArticleJSONLD_ValidBlogPosting(t *testing.T) {
	...
	raw := seo.ArticleJSONLD("https://ex.com", model.Article{
		Slug: "hello", Title: "Hello World", SEOTitle: "SEO Hello", PublishedAt: &pub,
	}, "A short desc", "https://ex.com/og.png")
